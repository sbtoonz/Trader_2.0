...
public class DragHandler : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler {
    ...
    public void Start(){
        ...
        if(canvas != null){
            ...
            // If DragHandler is on the same GameObject as the Canvas, drag the "Store" child instead
            if (canvasRectTransform == (transform as RectTransform))
            {
                var storeChild = transform.Find("Store");
                panelRectTransform = storeChild != null ? (storeChild as RectTransform)! : (transform as RectTransform)!;
            }
            else
            {
